...
const WorkspaceDashboard = lazy(() =>
  import('@/modules/vibe-builder/pages/workspace-dashboard').then((module) => ({
    default: module.WorkspaceDashboard,
  }))
);
const EditorPage = lazy(() =>
  import('@/modules/vibe-builder/pages/editor-page').then((module) => ({
    default: module.EditorPage,
  }))
);
const PublicSitePage = lazy(() =>
  import('@/modules/vibe-builder/pages/public-site-page').then((module) => ({
